...
const Badge = () => {
  return (
        <div className="font-oxygen text-sm lg:text-base lg:flex w-full 2xl:w-10/12 2xl:mx-auto px-4 lg:px-8 2xl:px-4 py-16">
            <div className="flex items-center justify-start lg:justify-center space-x-10 w-full overflow-x-auto hide-scroll-bar lg:overflow-x-hidden">
